...
function x = macroLocalColombia(x)
    ...
    x.c1_roc_y_tnd = 0.005; % Hysteresis from output gap

    % Phillips curve
    x.c0_roc_cpi = 0.6 % Lag
    x.c1_roc_cpi = 0.10/4; % Output gap
    x.c2_roc_cpi = 0.05/4; % Real exchange rate gap
    x.c3_roc_cpi = 0; % Real exchange rate gap change

    % Inflation expectations
    x.c1_roc_cpi_exp = 1;0.85;
